...
const createMovieItemTemplte = (movie) => `
    <div class="movie-item">
        <div class="movie-item__header">
            ...
            <div class="movie-item__header__rating">
                <p>
                    ⭐️
                    <span class="movie-item__header__rating__score">${movie.vote_average}</span>
                </p>
            </div>
        </div>
...
export { createMovieDetailTemplate, createMovieItemTemplte };